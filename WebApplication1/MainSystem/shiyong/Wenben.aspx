<%@ Page Title="" Language="C#" MasterPageFile="~/MainSystem/Master/111.Master" AutoEventWireup="true" CodeBehind="Wenben.aspx.cs" Inherits="WebApplication1.MainSystem.shiyong.Wenben" %>
...
<script type="text/javascript">
  ...
  <table border="1" width="400" height="150">
	...
	<tr>
		...
		<td>选择开始时间：<input type="text" style="width:70px" onfocus="HS_setDate(this)"></td>
	
	</tr>
	<tr>
		<td>选择结束时间：<input type="text" style="width:70px" onfocus="HS_setDate(this)"></td>
	</tr>
</table>
</asp:Content>
